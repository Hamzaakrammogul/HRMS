                ...
                <div className=''>
                    ...
                    <div className='flex flex-col items-center justify-center my-5'>
                        <div className='flex flex-col items-center space-y-4'>
                            <div className='w-36 h-36 rounded-xl overflow-hidden'><img src={data[0].img} /></div>
                        ...
                        <div className='flex md:w-full 2xl:w-[70%] ml-20 mb-5'>
                            ...
                            <div className='w-1/2 flex flex-col space-y-5 mt-5'>
                                <div className='flex flex-col w-[80%] h-16 bg-dusty rounded-md px-5 pt-2'>
                                    ...
                                    <div className='flex'>
                                    <input onChange={(e) => setData({ ...data1, department: e.target.value })} value={data1.department} type='text' id='department' className='bg-dusty text-sm w-full font-semibold outline-none' />
                                    <TbEdit/>
                                    </div>
                                </div>
                                <div className='flex flex-col w-[80%] h-16 bg-dusty rounded-md px-5 pt-2'>
