...
const SignUp = () => {
    ...
    const navFun = () => {
        if (eValid.current.value === "hamza@techilab.com" && pValid.current.value === "hamza") {
            navigate('/main')
        } else {
            console.log('Wrong')
        }
        ...
        <div className='container mx-auto'>
            ...
            <div className='bg-white flex items-center justify-center h-screen -mt-16'>
                <div className='w-[350px] h-[400px] shadow-xl p-5'>
                    ...
                    <form onKeyDown={(e)=>e.key==='Enter' && onSubmitHandler} onSubmit={onSubmitHandler} className=' flex flex-col gap-5 mt-7 '>
                        ...
                        <Button type='submit'  className='bg-bgBlue '>Sign in</Button>
                    </form>
                </div>
            </div>
        </div>
